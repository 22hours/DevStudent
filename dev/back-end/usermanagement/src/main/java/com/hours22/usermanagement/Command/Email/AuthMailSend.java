package com.hours22.usermanagement.Command.Email;
...
public class AuthMailSend {
    ...
    public String authMailSend(String email, String _id) {
        ...
        String htmlStr = "<h2>안녕하세요. DevStudent 계정인증 메일입니다!</h2><br><br>"
                ...
                + "<a href='http://devstudent/email/"+key+"'>인증하기</a></p>";
...
//                + _id + "&#34;, authState:&#34;"+ key +"&#34;){_id, authState}}'>인증하기</a></p>";
        ...
        return key;
//        userDao.GetKey(_id, key);
//        MimeMessage mail = mailSender.createMimeMessage();
//        String htmlStr = "<h2>안녕하세요 MS :p devStudent 입니다!</h2><br><br>"
//                + "<h3>" + _id + "님</h3>" + "<p>인증하기 버튼을 누르시면 로그인을 하실 수 있습니다 : "
