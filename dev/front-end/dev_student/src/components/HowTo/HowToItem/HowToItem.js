    ...
    render() {
        ...
        const StatsArea =({children}) =>{
            if(solved){
                return(
                    <div className="stats-inner-box ">
                        <div className="stats-inner-box-solved">
                        {children}
                        </div>
                    </div>
                    );
            ...
            if(answers < 1){
                return(
                <div className="stats-inner-box ">
                    <div className="stats-inner-box-default">
                    {children}
                    </div>
                </div>
                );
                ...
                return(
                    <div className="stats-inner-box stats-inner-box-hot">
                        <div className="stats-inner-box-hot">
                        {children}
                        </div>
                    </div>
                );
            ...
            <React.Fragment>
                <div className="howto-item-wrapper">
                    ...
                    <div className="stats-area-mobile">
                            ...
                            <div className="stats-inner-box">                                <div className="views-number-wrapper">
