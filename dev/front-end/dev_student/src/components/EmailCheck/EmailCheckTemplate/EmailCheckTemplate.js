...
const EmailCheckTemplate = ({rand}) => {
    ...
    return(
        ...
        <Container>
            ...
            <Row>
                <Button onClick={handleUpdateAuthState} color="primary">이메일 인증</Button>
            </Row>
        </Container>
        </div>
    );
...
export default EmailCheckTemplate;